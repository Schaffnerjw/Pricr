...
// "pending" = signed up, has not yet completed Stripe checkout — gated until card captured.
// "trialing" = card on file, Stripe-managed trial, auto-charges on day 3.
// "trial" = legacy local-clock trial (pre-billing accounts only; new signups never get this).
// "active" = paying; "veraa" = partner waiver; "expired" = ended/payment lapsed.
export type SubscriptionStatus = "active" | "veraa" | "trial" | "trialing" | "expired" | "pending";
